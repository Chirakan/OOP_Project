...
public class Player extends Entity{
	...
	public Player(float x, float y, int width, int height, Play playing) {
		super(x, y, width, height);
		this.playing = playing;
		loadAnimations();
		initHitbox(x , y, 25 * Game.SCALE, 30 * Game.SCALE); //ขนาดกรอบ hitbox
		initAttackBox();
	}
	...
	private void checkSignTouched() {
		playing.checkSignTouched(hitbox);
